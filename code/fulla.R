predictstate = function(df_frame, ages, nstates, mode) {
  nar = array(
    data = NA,
  ...
  for (i in 1:length(ages)) {
    ...
    if (nrow(atrisk) < 1) {
      ...
      coef_int[i, "Health", 1] = as.numeric(coef(fit2))[1]
      se_int[i, "Health", 1] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_int[i, "Cad", 1] = as.numeric(coef(fit2))[1]
      se_int[i, "Cad", 1] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_int[i, "death", 1] = coef(fit2)[1]
      se_int[i, "death", 1] = sqrt(diag(vcov(fit2)))[1]
      rm(atrisk)
    }
    ...
    if (nrow(atrisk) < 1) {
      ...
      coef_cont[i, "Cad", 2] = coef(fit2)[2]
      se_cont[i, "Cad", 2] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 2] = coef(fit2)[1]
      se_int[i, "Cad", 2] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Ht", 2] = coef(fit2)[2]
      se_cont[i, "Ht", 2] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Ht", 2] = coef(fit2)[1]
      se_int[i, "Ht", 2] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 2] = coef(fit2)[2]
      se_cont[i, "death", 2] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 2] = coef(fit2)[1]
      se_int[i, "death", 2] = sqrt(diag(vcov(fit2)))[1]
    ...
    if (nrow(atrisk) < 1) {
      ...
      coef_cont[i, "Cad", 3] = coef(fit2)[2]
      
      se_cont[i, "Cad", 3] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 3] = coef(fit2)[1]
      
      se_int[i, "Cad", 3] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "HyperLip", 3] = coef(fit2)[2]
      se_cont[i, "HyperLip", 3] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "HyperLip", 3] = coef(fit2)[1]
      
      se_int[i, "HyperLip", 3] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 3] = coef(fit2)[2]
      se_cont[i, "death", 3] = sqrt(diag(vcov(fit2)))[2]
      coef_cont[i, "death", 3] = coef(fit2)[2]
      se_cont[i, "death", 3] = sqrt(diag(vcov(fit2)))[2]
      rm(atrisk)
    ...
    if (nrow(atrisk) < 1) {
      ...
      coef_cont[i, "Cad", 4] = coef(fit2)[2]
      se_cont[i, "Cad", 4] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 4] = coef(fit2)[1]
      se_int[i, "Cad", 4] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Dm", 4] = coef(fit2)[2]
      se_cont[i, "Dm", 4] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Dm", 4] = coef(fit2)[1]
      se_int[i, "Dm", 4] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 4] = coef(fit2)[2]
      se_cont[i, "death", 4] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 4] = coef(fit2)[1]
      se_int[i, "death", 4] = sqrt(diag(vcov(fit2)))[1]
    ...
    if (nrow(atrisk) < 1) {
      ...
      coef_cont[i, "death", 5] = coef(fit2)[2]
      se_cont[i, "death", 5] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 5] = coef(fit2)[1]
      se_int[i, "death", 5] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Cad", 5] = coef(fit2)[2]
      se_cont[i, "Cad", 5] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 5] = coef(fit2)[1]
      se_int[i, "Cad", 5] = sqrt(diag(vcov(fit2)))[1]
      rm(atrisk)
    }
    ...
    if (nrow(atrisk) < 1)
    {
      ...
      coef_cont[i, "Cad", 9] = coef(fit2)[2]
      se_cont[i, "Cad", 9] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 9] = coef(fit2)[1]
      se_int[i, "Cad", 9] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 9] = coef(fit2)[2]
      se_cont[i, "death", 9] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 9] = coef(fit2)[1]
      se_int[i, "death", 9] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Ht&Dm", 9] = coef(fit2)[2]
      se_cont[i, "Ht&Dm", 9] = sqrt(diag(vcov(fit2)))[2]
      
      coef_int[i, "Ht&Dm", 9] = coef(fit2)[1]
      se_int[i, "Ht&Dm", 9] = sqrt(diag(vcov(fit2)))[1]
      rm(atrisk)
    ...
    if (nrow(atrisk) < 1)
    {
      ...
      coef_cont[i, "death", 8] = coef(fit2)[2]
      se_cont[i, "death", 8] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 8] = coef(fit2)[1]
      se_int[i, "death", 8] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Cad", 8] = coef(fit2)[2]
      se_cont[i, "Cad", 8] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Cad", 8] = coef(fit2)[1]
      se_int[i, "Cad", 8] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "HyperLip&Dm", 8] = coef(fit2)[2]
      se_cont[i, "HyperLip&Dm", 8] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "HyperLip&Dm", 8] = coef(fit2)[1]
      se_int[i, "HyperLip&Dm", 8] = sqrt(diag(vcov(fit2)))[1]
    ...
    if (nrow(atrisk) < 1)
    {
      ...
      coef_cont[i, "Cad", 7] = coef(fit2)[2]
      se_cont[i, "Cad", 7] = sqrt(diag(vcov(fit2)))[2]
      
      coef_int[i, "Cad", 7] = coef(fit2)[1]
      se_int[i, "Cad", 7] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Ht&HyperLip", 7] = coef(fit2)[2]
      se_cont[i, "Ht&HyperLip", 7] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Ht&HyperLip", 7] = coef(fit2)[1]
      se_int[i, "Ht&HyperLip", 7] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 7] = coef(fit2)[2]
      se_cont[i, "death", 7] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 7] = coef(fit2)[1]
      se_int[i, "death", 7] = sqrt(diag(vcov(fit2)))[1]
    ...
    if (nrow(atrisk) < 1)
    {
      ...
      coef_cont[i, "Cad", 10] = coef(fit2)[2]
      se_cont[i, "Cad", 10] = sqrt(diag(vcov(fit2)))[2]
      
      coef_int[i, "Cad", 10] = coef(fit2)[1]
      se_int[i, "Cad", 10] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "Ht&HyperLip&Dm", 10] = coef(fit2)[2]
      se_cont[i, "Ht&HyperLip&Dm", 10] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "Ht&HyperLip&Dm", 10] = coef(fit2)[1]
      se_int[i, "Ht&HyperLip&Dm", 10] = sqrt(diag(vcov(fit2)))[1]
      ...
      coef_cont[i, "death", 10] = coef(fit2)[2]
      se_cont[i, "death", 10] = sqrt(diag(vcov(fit2)))[2]
      coef_int[i, "death", 10] = coef(fit2)[1]
      se_int[i, "death", 10] = sqrt(diag(vcov(fit2)))[1]
