...
```{r, out.width= "500px", echo=FALSE}
knitr::include_graphics("frsshot.png",error = FALSE)
```
...
Calibrated ...
```{r}
s=readRDS("output/sharedrmse.rds")
```
...
## Thank you!
* ALL the members of the Gusev Lab! and..
