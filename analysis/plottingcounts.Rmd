...
# m=melt(d,id.var="ages")
# 
# ga2=ggplot(m,aes(ages,value,fill=variable))+geom_bar(stat="identity")+theme_classic()+labs(fill="Dynamic Metric",x="Age",y="Proportion Controls Captured")
# 
# 
# saveRDS(ga,"../output/proportioncontrolstenmslife.rds")
# ###
```
...
# 
# ggsave(g1,file="~/multistate2/output/proportioncasescaptured.pdf",dpi=600)
# ```
...
ggsave(g1,file="~/multistate2/output/proportioncasescaptured_not1.83.pdf",dpi=600)
```
...
ggsave(g1,file="~/multistate2/output/controlscaptured_not183.pdf",dpi=600)
```
