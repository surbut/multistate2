...
ggsave(ggarrange(p,p2,p3,cp,nrow=2,ncol=2),file="../output/thresholdexceeded_183.pdf")
```
...
df=test
score1_list=states
score2=readRDS("~/multistate2/output/ascvd.30year.rcnew.rds")/1.83
...
saveRDS(p,"../output/continuosums_lifetime_1.83.rds")
