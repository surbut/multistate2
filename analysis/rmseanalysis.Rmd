...
ggplot(m,aes(V1,value,fill=interaction(variable,as.factor(V1))))+geom_bar(stat="identity",position="dodge")+facet_wrap(~start,scales = "free")+theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+theme_classic()
