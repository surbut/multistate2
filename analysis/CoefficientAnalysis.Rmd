...
a1=plotfuncrmse(ascvd.ten.year = ascvd.30.year,emp.ten.year = emp.lifetime,mstate.ten.year = lifetime.new)$m+ggtitle("RMSE 30 year")+labs(y="RMSE %, 30 year")+ylim(c(0,0.60))

a2=plotfuncrmse(ascvd.ten.year = ascvd.30.year.rc,emp.ten.year = emp.lifetime,mstate.ten.year = lifetime.new)$m+ggtitle("RMSE 30 year,recalibrated")+ylim(c(0,0.60))+theme(axis.title.x=element_blank(),axis.title.y=element_blank())

figure <- ggarrange(a1 + rremove("ylab") + rremove("xlab"), a2 + rremove("ylab") + rremove("xlab"), # remove axis labels from plots
labels = NULL,
ncol = 1, nrow = 2,
...
library(ggpubr)
saveRDS(ggarrange(a1,a2,common.legend = TRUE,legend = "right"),file = "output/sharedrmse.rds")
