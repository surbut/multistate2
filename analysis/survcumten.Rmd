...
tenlb = function(start,
  ...
  labs(x="Age", y="Predicted Lifetime Risk (%)", fill="Strata", color="Strata", linetype="Strategy") +
  theme_classic()
...
s=ggplot(m, aes(x = ages, y = value, color = StrataLabel)) +
geom_line(size = 1.5) +
geom_point(size = 3) +
scale_color_manual(values = c(
"Female Low" = "lightpink",
"Female Medium" = "pink",
"Female High" = "hotpink",
"Male Low" = "lightblue",
"Male Medium" = "cornflowerblue",
"Male High" = "royalblue")) +
labs(title = "Predicted Survival Over 40 Years",
x = "Age",
y = "Survival Rate",
color = "Sex and Genetic Risk (PRS) Level") +
theme_classic(base_size = 20)
ggsave(s,file="../output/survoverall.pdf",dpi=600)
