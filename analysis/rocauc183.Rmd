...
for (z in 1:length(enrollments)) {
  ...
  df_updated$frs.recal = f$frs_recali/1.83
...
saveRDS(aucmat,file = "../output/auc_30year_183.rds")
saveRDS(prcmat,file = "../output/prc_30year_183.rds")
...
align = "hv",font.label = list(size = 10, color = "black", face = "bold", family = NULL, position = "top"))
...
ggsave(fig,file="../output/jointaucprc_30_183.pdf",dpi=600,width=10,height=8,units = "in")
```
