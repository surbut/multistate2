...
# Plot the ECDF
cadage=ggplot(plot_data, aes(x = cad.prs, y = ecdf_val, color = age_category)) +
  geom_step() +
  labs(title = "empirical CDF of PRS by Age of 1st CAD Diagnosis",
       x = "CAD-PRS",
       y = "eCDF",
       color="CAD Age") + scale_color_aaas()+
  theme_classic()


ggarrange(statage,cadage,common.legend = T)
